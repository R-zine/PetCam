...
class CheckpointError(RuntimeError):
    """Base exception for invalid or unreadable PetCam checkpoints."""
...
def load_checkpoint(
    ...
    """Load and minimally validate a PetCam checkpoint."""
...
def validate_checkpoint_compatibility(
    ...
    *,
    ...
    if str(checkpoint.get("model_name")) != str(model_name):
        differences.append(f"model_name ({checkpoint.get('model_name')!r} != {model_name!r})")
